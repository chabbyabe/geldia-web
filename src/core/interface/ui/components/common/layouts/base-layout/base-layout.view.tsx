...
import { NavbarContainer } from '@interface/ui/components/common/navbar/navbar.container';
import { SidebarContainer } from '@interface/ui/components/common/sidebar/sidebar.container';
    ...
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: 'flex' }}>
        ...
        <SidebarContainer
          onToggleSidebar={props.onToggleSidebar}
          sidebarOpen={props.sidebarOpen}
          currentPage={props.sidebarCurrentPage}
        />
        <Box
          component="main"
          sx={{
