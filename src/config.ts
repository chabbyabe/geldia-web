...
export const DEFAULT_LOCALE: string = process.env.REACT_APP_DEFAULT_LOCALE ?? 'en-US'
export const DEFAULT_CURRENCY: string = process.env.REACT_APP_DEFAULT_CURRENCY ?? 'USD'
